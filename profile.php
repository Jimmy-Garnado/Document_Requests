          ...
          <form id="changePictureForm" enctype="multipart/form-data">
            ...
            <div class="modal-body text-center">
              <img id="picturePreview"
                src="<?php echo ($row['image_url'] === 'none') ? '/images/default.png' : "." . $row['image_url']; ?>"
                alt="Preview" class="img-thumbnail mb-3" style="width: 150px; height: 150px; object-fit: cover;" />
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12 col-md-4 d-flex justify-content-center align-items-center">
                    <img
                      src="<?php echo ($row['image_url'] === 'none') ? '/images/default.png' : "." . $row['image_url']; ?>"
                      alt="Profile Picture" class="img-fluid" style="width: 200px; height: 200px; object-fit: cover;" />
                  </div>
                  <div class="col-12 col-md-8">
                    <div class="form-group mb-2">
                      <label class="form-label mb-0 fw-semibold">Student Name</label>
                      <input name="stuname" type="text" class="mt-2 form-control" value="<?php echo $row['stuname']; ?>"
                        readonly />
                    </div>
                    <div class="form-group mb-2">
                      <label class="form-label mb-0 fw-semibold">Student ID</label>
                      <input name="stuid" type="text" class="mt-2 form-control" value="<?php echo $row['stuid']; ?>"
                        readonly />
                    </div>
                    <div class="form-group mb-2">
                      <label class="form-label mb-0 fw-semibold">Student Email</label>
                      <input name="stuemail" type="text" class="mt-2 form-control"
                        value="<?php echo $row['stuemail']; ?>" readonly />
                    </div>
                    <div class="form-group mb-2">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="form-group mb-2">
                  ...
                  <input type="date" name="birthday" class="mt-2 form-control" value="<?php echo $row['birthday']; ?>"
                    required />
                </div>
                <div class="form-group mb-2">
                  <label class="form-label mb-0 fw-semibold">Contact Number</label>
                  <input type="text" name="contact_number" class="mt-2 form-control"
                    value="<?php echo ($row['contact_number'] === 'none') ? '' : $row['contact_number']; ?>" required />
                </div>
                <div class="form-group mb-2">
                  <label class="form-label mb-0 fw-semibold">Email</label>
                  <input type="text" name="email" class="mt-2 form-control"
                    value="<?php echo ($row['email'] === 'none') ? '' : $row['email']; ?>" required />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group mb-2">
                  ...
                  <input type="text" name="street" class="mt-2 form-control"
                    value="<?php echo ($row['street'] === 'none') ? '' : $row['street']; ?>" required />
                </div>
                <div class="form-group mb-2">
                  <label class="form-label mb-0 fw-semibold">Barangay</label>
                  <input type="text" name="barangay" class="mt-2 form-control"
                    value="<?php echo ($row['barangay'] === 'none') ? '' : $row['barangay']; ?>" required />
                </div>
                <div class="form-group mb-2">
                  <label class="form-label mb-0 fw-semibold">City</label>
                  <input type="text" name="city" class="mt-2 form-control"
                    value="<?php echo ($row['city'] === 'none') ? '' : $row['city']; ?>" required />
                </div>
                <div class="form-group mb-2">
                  <label class="form-label mb-0 fw-semibold">Province</label>
                  <input type="text" name="province" class="mt-2 form-control"
                    value="<?php echo ($row['province'] === 'none') ? '' : $row['province']; ?>" required />
                </div>
              </div>
            </div>
            <div class="card mt-4">
